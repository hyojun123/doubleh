            ...
            <div class="col-md-3">
                <div class="footer-widget fl-wrap">
                    ...
                    <div class="footer-contacts-widget fl-wrap">
                        <p>아직 상용화가 되지 않았습니다.</p>
                        <ul  class="footer-contacts fl-wrap">
                            <li><span><i class="fa fa-envelope-o"></i> Mail :</span><a href="#" target="_blank">chlgkwk123@nate.com</a></li>
                            <li> <span><i class="fa fa-map-marker"></i> Adress :</span><a href="#" target="_blank">서울 영등포구 대림동</a></li>
                            <li><span><i class="fa fa-phone"></i> Phone :</span><a href="#">010-2716-6790</a></li>
                        </ul>
                    </div>
                </div>
            </div>
