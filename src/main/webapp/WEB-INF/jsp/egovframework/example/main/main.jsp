        ...
        <div class="container">
            ...
            <div class="main-search-input-wrap">
                <div class="main-search-input fl-wrap">
                    ...
                    <button class="main-search-button" onclick="window.location.href='listings-half-screen-map-list.html'">검색</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="grid-item-holder">
                    <div class="listing-item-grid">
                        ...
                        <div class="listing-item-cat">
                            <h3><a href="listing.html">오늘은 간단히 식사와함께 술을</a></h3>
            ...
            <div class="gallery-item gallery-item-second">
                <div class="grid-item-holder">
                    <div class="listing-item-grid">
                        ...
                        <div class="listing-item-cat">
                            <h3><a href="listing.html">우리 조용히 대화하면서 먹을때 없나?</a></h3>
                            <p>저희가 알려드리겠습니다.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="gallery-item">
                <div class="grid-item-holder">
                    <div class="listing-item-grid">
                        ...
                        <div class="listing-item-cat">
                            <h3><a href="listing.html">오늘 밤 이성과 함께 놀고싶다면?</a></h3>
                            <p>물론 용기는 필수!</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="gallery-item">
                <div class="grid-item-holder">
                    <div class="listing-item-grid">
                        ...
                        <div class="listing-item-cat">
                            <h3><a href="listing.html">소개팅하고나서 같이먹을 분위기좋은 술집어디없나?</a></h3>
            ...
            <div class="gallery-item">
                <div class="grid-item-holder">
                    <div class="listing-item-grid">
                        ...
                        <div class="listing-item-cat">
                            <h3><a href="listing.html">모르겠음</a></h3>
                            <p>생각좀..</p>
                        </div>
                    </div>
                </div>
